  ...
  return (
    <div className="skills">
      ...
      <BoxContainer>
        <HighlightSection
          title="Git & Github"
          description="It uses Git software, providing the distributed version control of Git plus access control, bug tracking, software feature requests, task management, continuous integration, and wikis for every project."
          destination="https://docs.github.com/en/get-started/using-git/about-git"
        >
        ...
        <TitleLabel text="Knowledgeable in the following commands" />
        <br />
        <Codebox
          code="git init"
          detail="Used to initialize a repository in your current directory."
        ></Codebox>
        <Codebox
          code="git add <file name>"
          detail="For staging changes in your specified file inside your project."
        />
      </BoxContainer>
      <BacktoTop />
      <hr />
